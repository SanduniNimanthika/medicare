              ...
              gradient: linearcolor(),
                  ...
                  Container(
                    child:  Form(
                      key: _formKey,
                      child: Padding(
                        padding: EdgeInsets.only ( top :90,bottom: 3*SizeConfig.heightMultiplier,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            // button
                            Padding(
                              padding: EdgeInsets.only (top:6*SizeConfig.heightMultiplier,bottom: 2.5*SizeConfig.heightMultiplier,),
                              child: Material(
                                ...
                                child: InkWell(
                                  onTap: ()async{
                                    if(_formKey.currentState.validate()){
                                      ...
                                      dynamic result =await _auth.registerWithEmailAndPassword(email, password,fullname,'telenumber','address','hometown',confirmpassword,context);
                                      if (result==null){
                                  ...
                                  child:buttonContainer(context, "Sign up", 43, null)
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                GestureDetector(
                                  ...
                                  child: Text("Login",
                                      style:Theme.of(context).textTheme.subhead.copyWith(color:Color(0xFF185a9d),fontSize: 19,fontWeight: FontWeight.bold )),
                                ),
                              ],
                            ),
